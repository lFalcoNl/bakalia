                    ...
                    <td className="p-2 text-end space-x-2">
                      {isEditing ? (
                        ...
                        <>
                          <button
                            onClick={() => startEdit(p)}
                              className="bg-yellow-600 my-2 text-white px-2 py-1 rounded hover:bg-yellow-700 rounded-full transition"
                          >
                            Редагувати
                          </button>
                          <button
                            onClick={() => deleteProduct(p._id)}
                            className="bg-red-600 my-2 text-white px-2 py-1 rounded hover:bg-red-700 rounded-full transition"
                          >
                            Видалити
                          </button>
                        </>
